---
lab:
  title: "Erstellen und Erkunden des Dashboard für verantwortungsbewusste\_KI"
---

# Erstellen und Erkunden des Dashboard für verantwortungsbewusste KI

Nachdem Sie Ihr Modell trainiert haben, sollten Sie es auswerten, um zu erkunden, ob seine Leistung wie erwartet ist. Neben Leistungsmetriken können Sie weitere Faktoren berücksichtigen. Das Dashboard für verantwortungsbewusste KI in Azure Machine Learning ermöglicht Ihnen, die Daten und die Vorhersagen des Modells zu analysieren, um Bias oder Unfairness zu erkennen.

In dieser Übung bereiten Sie Ihre Daten auf und erstellen in Azure Machine Learning ein Dashboard für verantwortungsbewusste KI.
...
## Erstellen einer Pipeline zur Bewertung von Modellen und Übermittlung aus einem Notebook

Nachdem Sie nun über alle erforderlichen Ressourcen verfügen, können Sie das Notebook ausführen, um die integrierten Komponenten der verantwortungsbewussten KI abzurufen, eine Pipeline zu erstellen und die Pipeline zu übermitteln, um ein Dashboard für die verantwortungsbewusste KI zu generieren.

1. Öffnen Sie das Notebook **Labs/10/Create Responsible AI dashboard.ipynb**.
