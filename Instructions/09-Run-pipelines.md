---
lab:
  title: Ausführen von Pipelines in Azure Machine Learning
---

# Ausführen von Pipelines in Azure Machine Learning

Mit dem Python SDK können Sie alle Aufgaben ausführen, die zum Erstellen und Betreiben einer Machine Learning-Lösung in Azure erforderlich sind. Anstatt diese Aufgaben einzeln auszuführen, können Sie die erforderlichen Schritte zum Aufbereiten von Daten, Ausführen von Trainingsskripts und andere Aufgaben mithilfe von Pipelines orchestrieren.

In dieser Übung führen Sie mehrere Skripts als Pipelineauftrag aus.
...
1. Warten Sie, bis das Skript abgeschlossen ist. Dies dauert in der Regel etwa 5–10 Minuten.
    ...
    <ol>
        ...
        <li>Laden Sie die Schulungsdaten von https://github.com/MicrosoftLearning/mslearn-azure-ml/raw/refs/heads/main/Labs/09/data/diabetes.csv herunter</li>
        <li>Navigieren Sie in Azure Machine Learning Studio zur Seite <b>Daten</b> und wählen Sie <b>+ Erstellen</b>.</li>
        <li>Nennen Sie die Datenressource <b>Diabetes-Daten</b> und überprüfen Sie, ob der Typ <b>Datei (uri_file)</b> ausgewählt ist. Wählen Sie <b>Weiter</b> aus.</li>
        <li>Wählen Sie <b>Aus lokalen Dateien</b> als Datenquelle und wählen Sie dann <b>Weiter</b>.</li>
        <li>Überprüfen Sie, ob <b>Azure Blob Storage</b> und <b>workspaceblobstore</b> als Zielspeichertyp bzw. -datenspeicher ausgewählt sind. Wählen Sie <b>Weiter</b> aus.</li>
        <li>Laden Sie die zuvor heruntergeladene .csv-Datei hoch und wählen Sie dann <b>Weiter</b>.</li>
        <li>Überprüfen Sie die Einstellungen für Ihr Asset und wählen Sie dann <b>Erstellen</b>.</li>
    </ol>
    </details>
...
Der Code zum Erstellen und Übermitteln einer Pipeline mit dem Python SDK wird in einem Notebook bereitgestellt.

1. Öffnen Sie das Notebook **Labs/09/Run a pipeline job.ipynb**.
