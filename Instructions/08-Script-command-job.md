...
1. Geben Sie der neuen Datei den Namen `train-classification-model.py`. 
...
1. Überprüfen Sie die Eigenschaften des Auftrags. Beachten Sie, dass **Befehl** den Wert des Parameters **command** des Befehlsauftrags enthält, also des Befehls, den Sie zum Ausführen des Skripts ausgeführt haben.
