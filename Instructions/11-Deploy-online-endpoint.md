...
Um ein Modell in einer Anwendung nutzen und Echtzeitvorhersagen erhalten zu können, müssen Sie das Modell auf einem verwalteten Onlineendpunkt bereitstellen. Ein MLflow-Modell kann problemlos bereitgestellt werden, da Sie weder die Umgebung definieren noch das Bewertungsskript erstellen müssen.

In dieser Übung stellen Sie ein MLflow-Modell für einen verwalteten Onlineendpunkt bereit und testen es anhand von Beispieldaten. 
...
1. Öffnen Sie das Notebook **Labs/11/Deploy to online endpoint.ipynb**.
