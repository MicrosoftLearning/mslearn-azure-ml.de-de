---
lab:
  title: Protokollieren und Registrieren von Modellen mit MLflow
---

# Protokollieren und Registrieren von Modellen mit MLflow

MLflow ist eine Open-Source-Plattform zur Verwaltung des gesamten Machine Learning-Lebenszyklus. Wenn Sie Modelle mit MLflow protokollieren, können Sie das Modell problemlos zwischen Plattformen und Workloads verschieben.

In dieser Übung verwenden Sie MLflow, um Machine Learning-Modelle zu protokollieren.
...
Sie verfügen nun über alle erforderlichen Ressourcen und können das Notebook ausführen, um Modelle mit MLflow zu trainieren und zu protokollieren.

1. Öffnen Sie das Notebook **Labs\10\Log models with MLflow.ipynb**.
